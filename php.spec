...
* Thu Jan 06 2011 David Hrbáč <david@hrbac.cz> - 5.2.16-1
- new upstream release
...
* Fri Mar 05 2010 David Hrbáč <david@hrbac.cz> - 5.2.13-1
- new upstream release
...
* Tue Apr 14 2009 Joe Orton <jorton@redhat.com> 5.2.9-1.el5s2
- update to 5.2.9

* Tue Mar 31 2009 Joe Orton <jorton@redhat.com> 5.2.6-4.el5s2
- add security fixes for json_decode() crash (#494530),
  and CVE-2008-5658 - including regression fix (#494531)

* Thu Feb 26 2009 Joe Orton <jorton@redhat.com> 5.2.6-3.el5s2
- add security fixes for CVE-2008-3658, CVE-2008-3660,
  CVE-2008-5498, CVE-2008-5557, CVE-2008-5814, CVE-2009-0754
  (#487371)

* Fri May  9 2008 Joe Orton <jorton@redhat.com> 5.2.6-2.el5s2
- update to 5.2.6

* Wed Feb 20 2008 Joe Orton <jorton@redhat.com> 5.2.5-1.el5s2
- rebuild for StackV2
